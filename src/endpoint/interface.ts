 ...
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export type IQueryEndpoint<TName extends string, TRequest extends IQuery<TFilter, TOrderBy> | void, TResponse, TFilter extends IFilter | void = void, TOrderBy extends IOrderBy | void = void, TQuery extends IQueryParams | void = void> = IEndpoint<TName, TRequest, IQueryResult<TResponse>, TQuery>;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export type IQueryEndpointCallback<TName extends string, TRequest extends IQuery<TFilter, TOrderBy> | void, TResponse, TFilter extends IFilter | void = void, TOrderBy extends IOrderBy | void = void, TQuery extends IQueryParams | void = void> = (req: INextApiRequest<TQuery, TRequest>, res: NextApiResponse<IQueryResult<TResponse>>) => void;
