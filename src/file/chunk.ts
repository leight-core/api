...
export type IChunkCommitEvent = <TRequest, TResponse, TQuery extends IQueryParams = any>(file: IFile, params: IEndpointParams<TRequest, TResponse, TQuery>) => Promise<IFile>;
